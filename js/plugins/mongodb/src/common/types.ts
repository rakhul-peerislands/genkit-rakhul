  ...
  .and(
    z.object({
      ...
      batchSize: z
        ...
        .describe('The batch size to use for the indexing'),
      skipData: z
        .boolean()
        .optional()
        .default(false)
        .describe('Whether to skip the data field'),
    })
  );
      ...
      z
        .object({
          ...
          quantization: z
            ...
            .describe('Type of automatic vector quantization for your vectors')
            .optional(),
        })
        .passthrough()
        .superRefine((data, ctx) => {
